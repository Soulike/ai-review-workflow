...
publication, and a structured-result review gate. Consumers supply configuration
...
gate; a completed review with an approved structured verdict passes. This is a comment
